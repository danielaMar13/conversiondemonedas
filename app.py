...
def getTasaConversion(tipo, tipoCambio):
    ...
    elif tipo == "dollar":tasa = tasaDollar[tipoCambio]
    elif tipo == "yenes":tasa = tasaYenes[tipoCambio]
    elif tipo == "euro":tasa = tasaEuros[tipoCambio]
    elif tipo == "won":tasa = tasaWon[tipoCambio]
    elif tipo == "soles":tasa = tasaSol[tipoCambio]
    elif tipo == "bolivares":tasa = tasaBolivar[tipoCambio]
    elif tipo == "quetzal":tasa = tasaQuetzal[tipoCambio]
    elif tipo == "yuanes":tasa = tasaYuanes[tipoCambio]
